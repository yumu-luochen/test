    ...
    <jsp:include page="/view/commons/header_menu.jsp"></jsp:include>
		...
		<nav aria-label="breadcrumb" style=" margin-left:-15px; margin-right:-15px;">
		  <ol class="breadcrumb">
		    ...
		    <li class="breadcrumb-item"><a href="#">客户管理</a></li>
		    <li class="breadcrumb-item active" aria-current="page">客户信息修改</li>
		  </ol>
		</nav>    
		</div>
     <div class="container-fluid col-md-6">
       <div class="row mx-2">
          <div class="col-12 col-md-8">
            <s:form namespace="/customer" action="updateCustomer"  method="post">
              <s:hidden name="customer.customerId"></s:hidden>
              <s:hidden name="customer.customerBook"></s:hidden>
              ...
              <div class="form-group">
			    <label>客户身份证号</label>
			    <s:textfield cssClass="form-control" name="customer.customerIdentity" placeholder="请输入客户的身份证号" maxlength="18"/>
			  </div> 
			  <hr>
			  <div class="form-group">
			    <label>客户联系方式</label>
			    <s:textfield cssClass="form-control" name="customer.customerPhone" placeholder="请输入客户的手机号" maxlength="20"/>
			  </div>
			  <hr>
			  <div class="form-group">
			    <label>客户联系方式</label>
