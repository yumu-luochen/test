    ...
    <jsp:include page="/view/commons/header_menu.jsp"></jsp:include>
		...
		<nav aria-label="breadcrumb" style=" margin-left:-15px; margin-right:-15px;">
		  <ol class="breadcrumb">
		    ...
		    <li class="breadcrumb-item active" aria-current="page">食品添加</li>
		  </ol>
		</nav>    
		</div>
       ...
       <div class="row mx-2">
          <div class="col-12 col-md-8">
            <s:form namespace="/food" action="saveFood"  method="post">
			  ...
			  <div class="form-group">
			    <label>食品分类</label>
			    <s:select cssClass="form-control" name="food.foodCategory.foodCategoryId" list="foodCategoryList" listKey="foodCategoryId" listValue="foodCategoryName" headerKey="" headerValue="-请选择食品分类-"/>
			  </div>
			  <hr>
			  <div class="form-group">
			    <label>食品购入价格</label>
			  ...
			  <hr>	
			  <div class="form-group">
			    <s:submit value="添加食品信息" cssClass="btn btn-primary"></s:submit>
			  </div>	             
            </s:form>
          </div>
       </div>
