...
<html>
  <head>
    ...
    <title>落尘酒店客房管理系统-管理员信息修改</title>
    ...
    <jsp:include page="/view/commons/header_menu.jsp"></jsp:include>
		...
		<nav aria-label="breadcrumb" style=" margin-left:-15px; margin-right:-15px;">
		  <ol class="breadcrumb">
		    ...
		    <li class="breadcrumb-item active" aria-current="page">管理员信息修改</li>
		  </ol>
		</nav>    
		</div>
     <div class="container-fluid col-md-6">
       <div class="row mx-2">
          <div class="col-12 col-md-8">
            <s:form namespace="/login" action="updateAdmin"  method="post">
        	  ...
        	  <div class="form-group">
			    ...
			    <s:textfield cssClass="form-control" name="admin.adminNo" placeholder="请输入管理员账号"/>
			  </div> 
			  <hr>	  			
			  <div class="form-group">
			    <label>管理员密码(最多6位)</label>
			    <s:password cssClass="form-control" name="admin.adminPwd" placeholder="请输入管理员的密码"/>
			  </div> 
			  <hr>  			  		
			  <div class="form-group">
